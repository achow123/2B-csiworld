...
function next(x) {
	...
	case 0:
		...
		document.getElementById("image").innerHTML="<img src='images/detective.png' alt='test' width='455'>";
		break;
	...
	document.getElementById("storyline").innerHTML = "That night, you, Patty and the rest of the detectives from your team go to a restaurant to celebrate your success. While you are eating, you look at the TV and find Regina's picture all over the screen. Next to that you find your picture with a title of 'Our Famous Detective'! Right then Patty gets everyone's attention and announces that you are promoted to head detective! You are thrilled by this news. Many successful years later, you become a world famous dectective and live to your dreams.";
	document.getElementById("remind").innerHTML = "Congratulations, Detective " + name + "! You lived a succesful life.";
	...
	document.getElementById("storyline").innerHTML = "You decide to look at the files for Susan Johnson. Detective Joe tells you that he found out that she was inhured and was in the hospital the same time as the shooting. You know that Susan can't be the murderer.";
...
function save_cookies(caseStr) {
	...
	//document.cookie = "name=" + n + "; " + expires;
